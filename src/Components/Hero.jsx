...
import mern from "../assets/cloud.png";

const Hero = () => {
  const heroData = {
    name: "AKSHAT VERMA",
    heading: "Cloud Consultant | Cloud Engineer | Azure | AWS",
    description: `Building scalable and secure cloud infrastructures using Azure, AWS, and containerized workloads. Experienced in VM provisioning, networking, automation scripting and deploying cloud-native applications.`,
    links: [
      {
